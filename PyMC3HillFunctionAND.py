...
for gate in gates:
    ...
    with pm.Model() as bayesian_model:
        ...
        k1 = BoundNormal('K1', mu=1e2, sigma=5e1)
        k2 = BoundNormal('K2', mu=1e2, sigma=5e1)
        n1 = BoundNormal('n1', mu=3, sigma=1)
        n2 = BoundNormal('n2', mu=3, sigma=1)
        ymin1 = BoundNormal('ymin1', mu=y.min(), sigma=1)
        ymin2 = BoundNormal('ymin2', mu=y.min(), sigma=1)
        ymax1 = BoundNormal('ymax1', mu=y.max(), sigma=1)
        ymax2 = BoundNormal('ymax2', mu=y.max(), sigma=1)
